...
Sou Sandro Joaquim dos Santos Filho, estudante do 1º período (P1), e este trabalho tem como objetivo aplicar os conhecimentos adquiridos em sala de aula na criação de uma página web estática, utilizando as linguagens HTML5 e CSS.
